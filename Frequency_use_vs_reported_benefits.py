...
# Agrupar os dados pela frequência de uso e calcular a média da percepção de melhoria
grouped_data = df.groupby('Frequency of use')['Perception of Improvement'].mean().reset_index()

# Verificar os valores únicos na coluna 'Frequency of use' para garantir que correspondemos corretamente os rótulos
...
# Definir os rótulos para o eixo x com base nos valores únicos da coluna 'Frequency of use'
